<template>
  <div class="items">
    ...
    <b-field :label="$t('settings.general.rootURL')" label-position="on-border"
      ...
      <b-input v-model="data['app.root_url']" name="app.root_url" placeholder="https://privatehouse.yoursite.com"
    ...
    <div class="columns">
      <div class="column is-6">
        <b-field :label="$t('settings.general.logoURL')" label-position="on-border"
          ...
          <b-input v-model="data['app.logo_url']" name="app.logo_url" placeholder="https://privatehouse.yoursite.com/logo.png"
      ...
      <div class="column is-6">
        <b-field :label="$t('settings.general.faviconURL')" label-position="on-border"
          ...
          <b-input v-model="data['app.favicon_url']" name="app.favicon_url"
            placeholder="https://privatehouse.yoursite.com/favicon.png" :maxlength="300"
    ...
    <b-field :label="$t('settings.general.fromEmail')" label-position="on-border"
      ...
      <b-input v-model="data['app.from_email']" name="app.from_email"
        placeholder="Dakota <noreply@endgate.systems>" pattern="((.+?)\s)?<(.+?)@(.+?)>" :maxlength="300" />
    </b-field>
    ...
    <b-field :label="$t('settings.general.language')" label-position="on-border" :addons="false">
      ...
      <p class="mt-2">
        <a href="https://www.endgate.systems/privatehouse" target="_blank" rel="noopener noreferer">{{
